...
public class LastFunctionTests {
    ...
    @Test
    void last_function_with_simple_condition_and_sugar_around_number_in_condition()
            throws Exception {
        String rule =
    ...
    void last_function_with_condition_group_with_explicit_array_path() throws Exception {
        String rule = "a last item from info.addresses with zip_code equals 12345 and city equals Berlin as a last address";
        String schema = "{info: {addresses:[{zip_code: 1, city: Berlin}]}}";
