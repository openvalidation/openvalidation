...
public class LastTest {
  ...
  void one_parameter_applied_on_static_string() throws Exception {
    runner.run(
        ...
        r ->
            r.containsValidationMessage(
                "The function LAST has to be applied on a property, variable or a nested function of type 'Array'. Currently applied on a string(ASTOperandStaticString)."));
  }
  ...
  void one_parameter_applied_on_static_number() throws Exception {
    runner.run(
        ...
        r ->
            r.containsValidationMessage(
                "The function LAST has to be applied on a property, variable or a nested function of type 'Array'. Currently applied on a number(ASTOperandStaticNumber)."));
  }

  @Test
  void one_parameter_applied_with_negative_amount() throws Exception {
    runner.run(
        "LAST -1 from numbers AS var",
        "{numbers: [1,2,3]}",
        r ->
            r.containsValidationMessage(
                "The function LAST only takes numbers with a value greater or equal to 1 as the second parameter. Current value is -1.0"));
  }
  ...
  void one_parameter_applied_on_variable_of_type_string() throws Exception {
    runner.run(
        "name AS var\n\n" + "LAST from var AS var2",
        "{name: Peter}",
        r ->
            r.containsValidationMessage(
                "The function LAST has to be applied on a variable of type 'Array'. But is applied on variable of type 'String'"));
  }
  ...
  void one_parameter_applied_on_variable_of_type_decimal() throws Exception {
    runner.run(
        ...
        r ->
            r.containsValidationMessage(
                "The function LAST has to be applied on a variable of type 'Array'. But is applied on variable of type 'Decimal'"));
  }
  ...
  void one_parameter_applied_on_variable_of_type_bool() throws Exception {
    runner.run(
        ...
        r ->
            r.containsValidationMessage(
                "The function LAST has to be applied on a variable of type 'Array'. But is applied on variable of type 'Boolean'"));
  }
  ...
  void one_parameter_applied_on_variable_of_type_object() throws Exception {
    runner.run(
        ...
        r ->
            r.containsValidationMessage(
                "The function LAST has to be applied on a variable of type 'Array'. But is applied on variable of type 'Object'"));
  }
