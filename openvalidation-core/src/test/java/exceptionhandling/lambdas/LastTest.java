    ...
    private ExceptionRunner runner = new ExceptionRunner();
      ...
      void one_parameter_applied_on_string_property() throws Exception {
          runner.run(
                  ...
                  "{name: Peter}",
                  r -> r.containsValidationMessage("The function LAST has to be applied on a property of type 'Array'. But is applied on property of type 'String'"));
      }
      ...
      void one_parameter_applied_on_decimal_property() throws Exception {
          runner.run(
                  ...
                  "{number: 1}",
                  r -> r.containsValidationMessage("The function LAST has to be applied on a property of type 'Array'. But is applied on property of type 'Decimal'"));
      }
      ...
      void one_parameter_applied_on_boolean_property() throws Exception {
          runner.run(
                  ...
                  "{married: true}",
                  r -> r.containsValidationMessage("The function LAST has to be applied on a property of type 'Array'. But is applied on property of type 'Boolean'"));
      }
      ...
      void one_parameter_applied_on_static_string() throws Exception {
          runner.run(
                  ...
                  r -> r.containsValidationMessage("The function LAST has to be applied on an array property or a nested function. Currently applied on ASTOperandStaticString"));
      }
}
