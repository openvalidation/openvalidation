...
public class PTConditionExprTransformer
    extends TransformerBase<
        PTConditionExprTransformer, ASTOperandBase, mainParser.Condition_exprContext> {
  public PTConditionExprTransformer(
      mainParser.Condition_exprContext treeCntx, TransformerContext fctx) {
    super(treeCntx, fctx);
  }
