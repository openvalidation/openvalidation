...
public class PTExpressionTransformer
    extends TransformerBase<PTExpressionTransformer, ASTOperandBase, mainParser.ExpressionContext> {

  public PTExpressionTransformer(mainParser.ExpressionContext treeCntx, TransformerContext fctx) {
    super(treeCntx, fctx);
  }
