...
public class PTUnknownTransformer
    extends TransformerBase<PTContentTransformer, ASTUnknown, mainParser.UnknownContext> {

  public PTUnknownTransformer(mainParser.UnknownContext treeCntx, TransformerContext fctx) {
    super(treeCntx, fctx);
  }

  @Override
  public ASTUnknown transform() throws Exception {
    ASTUnknown item = new ASTUnknown();
    item.setSource(this.antlrTreeCntx.getText());
