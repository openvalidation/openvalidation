...
public class FunctionLastTypeResolver extends FunctionTypeResolverBase {

  public FunctionLastTypeResolver(ASTOperandFunction function) {
    super(function);
  }
  ...
  public DataPropertyType resolveType() {
    ...
    if (parameters.size() > 0) {
      ...
      if (firstParam instanceof ASTOperandProperty
        ...
        functionReturnType =
            FunctionUtils.resolveFunctionReturnType((ASTOperandFunction) firstParam);
      }
    }
