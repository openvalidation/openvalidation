...
//  //
//      /**
//       * Convenience function to create {@link OpenValidationParameters} from a flat Map of
// parameters
//       *
...
//   * Apply all parameters to the given instance of {@link OpenValidation}. Note that the
// configured
//   * instance won't have the {@link #disableFrameworkGeneration} property set, because this
// property
...
//    if (this.generatedClassName != null) result.put(GENERATED_CLASS_NAME,
...
//    // setRule()), but this would result to more side effects between setters and developers
// should
