...
public class GeneratorArrayTest {
  private static Stream<Arguments> array_with_numbers() {
    return Stream.of(
        //                            language      expected
        Arguments.of("javascript", "huml.NONE_OF(model.Age, [3.0,4.0,5.0])"),
        Arguments.of("csharp", "huml.NONE_OF(model.Age, 3.0,4.0,5.0)"),
        Arguments.of("java", "huml.NONE_OF(model.getAge(), 3.0,4.0,5.0)"),
